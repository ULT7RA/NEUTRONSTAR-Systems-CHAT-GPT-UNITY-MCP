...
namespace MCPForUnity.Editor.Clients.Configurators
{
    ...
    public class OpenClawConfigurator : McpClientConfiguratorBase
    {
        ...
        public override IList<string> GetInstallationSteps() => new List<string>
        {
            ...
            "In NEUTRONSTAR Systems CHAT GPT MCP, choose OpenClaw and click Configure",
            "OpenClaw uses the currently selected NEUTRONSTAR Systems CHAT GPT MCP transport (HTTP or stdio)",
