...
{
    /// <summary>
    /// Service for controlling the NEUTRONSTAR Systems CHAT GPT MCP Bridge connection
    /// </summary>
    public interface IBridgeControlService
    {
        ...
        /// <summary>
        /// Starts the NEUTRONSTAR Systems CHAT GPT MCP Bridge asynchronously
        /// </summary>
        /// <returns>True if the bridge started successfully</returns>
        Task<bool> StartAsync();

        /// <summary>
        /// Stops the NEUTRONSTAR Systems CHAT GPT MCP Bridge asynchronously
        /// </summary>
        Task StopAsync();
