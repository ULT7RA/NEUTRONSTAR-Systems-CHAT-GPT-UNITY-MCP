...
namespace MCPForUnity.Editor.Windows
{
    ...
    public class MCPSetupWindow : EditorWindow
    {
        ...
        private void PopulateClientsList()
        {
            ...
            {
                clientsList.Add(new Label("No supported MCP clients detected on this machine. You can configure clients later from Tools → NEUTRONSTAR Systems CHAT GPT MCP."));
        ...
        private void UpdateUI()
        {
            ...
            if (_dependencyResult.IsSystemReady)
            {
                statusMessage.text = "✓ All requirements met! NEUTRONSTAR Systems CHAT GPT MCP is ready to use.";
                statusMessage.style.color = new StyleColor(Color.green);
                installationSection.style.display = DisplayStyle.None;
            }
            else
            {
                statusMessage.text = "⚠ Missing dependencies. NEUTRONSTAR Systems CHAT GPT MCP requires all dependencies to function.";
